                        ...
                        <FormItem>
                            <FormControl>
                                <div className="relative p-4 pb-16">
                                    <Button onClick={() => {}} type="button" className="absolute top-7 left-8 h-[24px] w-[24px] bg-zinc-500 dark:bg-zinc-400 hover:bg-zinc-600 dark:hover:bg-zinc-300 rounded-full p1 flex items-center justify-center">
